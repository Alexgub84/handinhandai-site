...
export const ui = {
  he: {
    ...
    'fitness.hero.lede': 'צ׳טבוט חכם בוואטסאפ שעונה ללקוחות, קובע שיעורי ניסיון ומזכיר על אימונים — בעברית, בקול שלכם.',
    ...
    'fitness.hero.mock.aside.body': 'לקוחה חדשה כותבת אחרי שעות הפעילות. הבוט מציע מועד אמיתי, מאשר את הפרטים, ושומר את השיעור ביומן של הסטודיו. את מתעוררת לפנייה סגורה.',
    'fitness.scenario2.label': 'תרחיש 2 · לחדרי כושר',
    'fitness.scenario2.heading': 'חבר ביטל ב-19:42. ב-19:43 המקום כבר תפוס.',
    'fitness.scenario2.desc': 'יש לך כבר אפליקציית הזמנות (Arbox, Mindbody)? הבוט מתחבר אליה. אין? הבוט הופך לאחת — מנהל רשימת המתנה, מקבל ביטולים, ומציע את המקום שהתפנה לראשון בתור. אוטומטית, גם ב-19:42 בערב.',
    'fitness.scenario3.label': 'תרחיש 3 · ל-MMA ואומנויות לחימה',
    'fitness.scenario3.heading': 'הבוט שואל. נועה עונה משהו אמיתי. אתה מקבל התראה.',
    'fitness.scenario3.desc': 'כל שיעור ניסיון מקבל פולואפ ביום שאחרי. תשובות שגרתיות נרשמות בלוח. תשובות שדורשות אותך — מגיעות מיידית בוואטסאפ, ואתה נכנס אישית לשיחה.',
    'fitness.explainer.title': 'רגע, מה זה בעצם "בוט AI"?',
    'fitness.explainer.item1': 'מתחבר למספר הוואטסאפ העסקי שלך — אותו מספר, בלי אפליקציה חדשה',
    'fitness.explainer.item2': 'לומד איך אתם מדברים, את המחירים ואת הלו״ז — ועונה כמוכם',
    'fitness.explainer.item3': 'שיחה אנושית, לא תפריט עם כפתורים. וכשצריך אתכם — מעביר אליכם',
    'fitness.explainer.closing': 'מתחבר ליומן הסטודיו שלך — Google Calendar, Arbox, Mindbody. אין אפליקציית הזמנות? נבנה לך אחת.',
    ...
    'fitness.faq.a3': 'שלושה דברים: שיחת היכרות של 30 דקות, מספר וואטסאפ עסקי פעיל, ורשימה קצרה של השאלות הכי נפוצות שלקוחות שואלים אתכם. זה הכל.',
    'fitness.faq.q4': 'האם זה תומך בעברית?',
    'fitness.faq.a4': 'כן, נבנה במקור לעברית — כולל RTL, סלנג ישראלי וטון אישי שמותאם לסטודיו שלכם.',
  ...
  en: {
    ...
    'fitness.hero.lede': 'A smart WhatsApp chatbot that responds to clients, books trial classes, and sends reminders — in your voice.',
    'fitness.hero.cta': 'Talk to me on WhatsApp',
    'fitness.hero.trust': 'No forms. No installation. Response usually the same day.',
    ...
    'fitness.hero.mock.aside.title': 'Message at 22:48. By morning, the class is booked.',
    'fitness.hero.mock.aside.body': 'A new client messages after hours. The bot offers a real time slot, confirms details, and saves the class to the studio calendar. You wake up to a closed inquiry.',
    'fitness.scenario2.label': 'Scenario 2 · Gyms',
    'fitness.scenario2.heading': 'A member cancelled at 19:42. By 19:43 the spot was taken.',
    'fitness.scenario2.desc': 'Already have a booking app (Arbox, Mindbody)? The bot connects to it. No app? The bot becomes one — managing the waitlist, taking cancellations, and offering the freed spot to the next person. Automatically, even at 19:42.',
    'fitness.scenario3.label': 'Scenario 3 · MMA & martial arts',
    'fitness.scenario3.heading': 'The bot asks. Noa replies with something real. You get an alert.',
    'fitness.scenario3.desc': 'Every trial class gets a follow-up the next day. Routine replies are logged. Replies that need you arrive instantly on WhatsApp, and you step in personally.',
    'fitness.explainer.title': 'Wait — what exactly is an "AI bot"?',
    'fitness.explainer.item1': 'Connects to your business WhatsApp number — same number, no new app',
    'fitness.explainer.item2': 'Learns how you talk, your pricing, and your schedule — and replies in your voice',
    'fitness.explainer.item3': 'A real conversation, not a button menu. And when you\'re needed — it hands off to you',
    'fitness.explainer.closing': 'Connects to your studio calendar — Google Calendar, Arbox, Mindbody. No booking app? We\'ll build you one.',
    ...
    'fitness.how.title': 'From first conversation to live — within a few weeks.',
    ...
    'fitness.about.title': 'Alex. Building personal AI assistants for small businesses in Israel.',
    ...
    'fitness.faq.a3': 'Three things: a 30-minute intro call, an active business WhatsApp number, and a short list of the most common questions your clients ask. That\'s it.',
    'fitness.faq.q4': 'Does it support Hebrew?',
    'fitness.faq.a4': 'Yes, built natively for Hebrew — including RTL, Israeli slang, and a personal tone tailored to your studio.',
    'fitness.footer.copyright': '© 2025 · Hand in Hand',
  },
} as const;
